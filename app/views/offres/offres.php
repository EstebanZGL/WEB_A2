<!-- Remplacer le code JavaScript existant dans la section script par celui-ci -->
<script>
        ...
        fetch(url)
            ...
            .then(data => {
                ...
                fetch("app/views/login/session.php")
                    .then(response => response.json())
                    .then(sessionData => {
                        // MODIFICATION : Afficher toujours les offres, avec wishlist seulement pour les étudiants
                    ...
                    .catch(error => {
                        ...
                        // MODIFICATION : En cas d'erreur, afficher quand même les offres
                        displayJobsWithoutWishlist(getPaginatedJobs());
                    });
            })
            .catch(error => {
