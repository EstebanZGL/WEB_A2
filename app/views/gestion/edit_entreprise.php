...
<head>
    ...
    <title>LeBonPlan | Modifier une entreprise</title>
    <meta name="description" content="Modifier une entreprise sur la plateforme LeBonPlan." />
            ...
            <section class="section">
                <div class="container">
                    <div class="form-container">
                        <h1 class="section-title">Modifier une entreprise</h1>
                        <a href="../../gestion?section=entreprises" class="button button-secondary">Retour à la liste</a>
                        
                        <form action="../../gestion/entreprises/edit?id=<?php echo $entreprise['id']; ?>" method="post" class="form">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="description" name="description" rows="4"><?php echo htmlspecialchars($entreprise['description']); ?></textarea>
                            </div>
                            
                            <div class="form-row">
                                <div class="form-group half">
                                    <label for="email_contact">Email de contact</label>
                                    <input type="email" id="email_contact" name="email_contact" value="<?php echo htmlspecialchars($entreprise['email_contact']); ?>" required>
                                </div>
                                
                                <div class="form-group half">
                                    <label for="telephone_contact">Téléphone de contact</label>
                                    <input type="tel" id="telephone_contact" name="telephone_contact" value="<?php echo htmlspecialchars($entreprise['telephone_contact']); ?>" required>
                                </div>
                            </div>
                            
                            <div class="form-group">
                                <label for="adresse">Adresse</label>
                                <textarea id="adresse" name="adresse" rows="2" required><?php echo htmlspecialchars($entreprise['adresse']); ?></textarea>
                            </div>
                            
                            <div class="form-group">
                                <label for="lien_site">Site web</label>
                                <input type="url" id="lien_site" name="lien_site" value="<?php echo htmlspecialchars($entreprise['lien_site']); ?>" placeholder="https://www.exemple.com">
                            </div>
